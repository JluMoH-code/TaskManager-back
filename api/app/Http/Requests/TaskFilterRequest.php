...
#[OA\Schema(
    properties: [
        ...
        'sort_by' => new OA\Property(property: 'sort_by', type: 'string', example: 'title', enum: ['title', 'deadline'], nullable: true),
        'sort_order' => new OA\Property(property: 'sort_order', type: 'string', example: 'asc', enum: ['asc', 'desc'], nullable: true),
...
class TaskFilterRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'sort_by' => ['nullable', 'string', 'in:title,deadline'],
